...
public class minstatement extends javax.swing.JFrame {
    ...
    /**
     * Creates new form minstatement
     */
    String accountnumber;
    public minstatement(String accountnumber) {
        this.accountnumber=accountnumber;
        initComponents();
        try{
            connect con=new connect();
            
            ResultSet rs=con.s.executeQuery("select * from transaction_detail where Account_No='"+accountnumber+"' ");
            while(rs.next()){
            jLabel2.setText( jLabel2.getText()+"<html>"+rs.getString("date")+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+ rs.getString("type")+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+rs.getString("amount") +"<br><br><html>" );
            }
        }catch(Exception e){
